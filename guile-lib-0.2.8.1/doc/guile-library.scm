...
(define *updated* "April 2024")
(define *authors*
  '(("Andreas Rottmann" . "rotty at debian dot org")
    ("Andy Wingo" . "wingo at pobox dot com")
    ("Richard Todd" . "richardt at vzavenue dot net")
    ("Neil W. Van Dyke" . "neil at neilvandyke dot org")
    ("David Pirotte" . "david at altosw dot be")
    ("Christopher Baines" . "mail at cbaines dot net")
    ("Göran Weinhold" . "weinhold at debian dot org")
    ("Ricardo Wurmus" . "rekado at elephly dot net")
    ("Ludovic Courtès" . "ludo at gnu dot org")
    ("Maxim Cournoyer" . "maxim dot cournoyer at gmail dot com")))

;; Copying the documentation
(define *copyright-holder* "Andreas Rottmann, Andy Wingo, Richard Todd, Neil W. Van Dyke, David Pirotte, Christopher Baines, Göran Weinhold, Ricardo Wurmus, Ludovic Courtès, Maxim Cournoyer")
(define *years* '(2003 2007 2010 2011 2016 2017 2018 2021 2024))
(define *permissions*
